...
export const messagesTranslations = {
    ...
    export_option_chat_png_desc: { en: 'A single, high-resolution image of the entire chat.', zh: '整段对话的单张高分辨率图片。' },
    export_option_chat_html_desc: { en: 'A self-contained file with text, code, and styles.', zh: '包含文本、代码和样式的自包含文件。' },
    export_option_chat_txt_desc: { en: 'A simple text file with the conversation content.', zh: '包含对话内容的纯文本文件。' },

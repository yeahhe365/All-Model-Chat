...
export const scenariosTranslations = {
    ...
    scenarios_system_prompt_expand: { en: 'Expand', zh: '展开' },
    scenarios_system_prompt_help: { en: 'Define the persona, style, and rules for the AI.', zh: '定义 AI 的角色、风格和规则。' },
    ...
    scenarios_add_message_as: { en: 'Add Message As', zh: '添加消息身份' },
    scenarios_role_user: { en: 'User', zh: '用户' },
    scenarios_role_model: { en: 'Model', zh: '模型' },
    scenarios_add_message_shortcut: { en: 'CMD/CTRL + Enter to Add', zh: '按 CMD/CTRL + Enter 添加' },
    ...
    scenarios_empty_title: { en: 'No scenarios found.', zh: '未找到场景。' },
    scenarios_clear_search: { en: 'Clear search query', zh: '清除搜索' },
    scenarioMessages_empty_title: { en: 'No messages yet.', zh: '还没有消息。' },
    scenarioMessages_empty_desc: { en: 'Add messages below to script the conversation flow.', zh: '在下方添加消息来编排对话流程。' },
    scenarioMessages_save_hint: { en: 'Press Enter to save', zh: '按 Enter 保存' },
};

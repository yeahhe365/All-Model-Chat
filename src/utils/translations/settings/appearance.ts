export const appearanceSettings = {
  ...
  settings_enableMermaidRendering_tooltip: {
  ...
  settings_enableGraphvizRendering_tooltip: {
  ...
  settings_autoFullscreenHtml_tooltip: {
  ...
  settings_enableCompletionNotification_tooltip: {
  ...
  settings_enableSuggestions_tooltip: {
  ...
  settings_audioCompression_tooltip: {
  ...
  settings_pasteRichTextAsMarkdown_tooltip: {
  ...
  settings_copySelectionFormatting_tooltip: {
  ...
  settings_systemAudioRecording_tooltip: {
  ...
  settings_hideThinkingInContext_tooltip: {

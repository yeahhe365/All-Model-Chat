...
export const modelSettings = {
    ...
    settingsGemmaThinkingToggle_label: { en: 'Think Before Answering', zh: '先思考再回答' },
    ...
    settings_filesApi_desc: { en: 'Control whether files are uploaded to Google Storage (Files API) or sent inline (Base64). Inline payloads are limited to 100MB per request, or 50MB for PDFs.', zh: '控制文件是上传到 Google 存储 (Files API) 还是内联发送 (Base64)。内联负载单次请求上限为 100MB，PDF 为 50MB。' },

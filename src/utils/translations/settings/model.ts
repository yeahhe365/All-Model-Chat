...
export const modelSettings = {
    ...
    settingsGemmaReasoningToggle_label: { en: 'Enable Gemma Reasoning', zh: '启用 Gemma 推理' },
    settingsGemmaReasoningToggle_enabledDesc: { en: 'Gemma will reason before replying, which usually improves quality but adds latency.', zh: 'Gemma 会先进行推理再作答，通常会提升质量，但会增加延迟。' },
    settingsGemmaReasoningToggle_disabledDesc: { en: 'Gemma will respond directly for a faster interaction.', zh: 'Gemma 会直接作答，整体响应会更快。' },

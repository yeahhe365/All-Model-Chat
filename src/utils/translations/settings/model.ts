...
export const modelSettings = {
    ...
    settingsSystemPrompt_active: { en: 'Active', zh: '已启用' },
    settingsSystemPrompt_expand: { en: 'Expand Editor', zh: '展开编辑器' },
    settingsSystemPrompt_input_aria: { en: 'System prompt text area', zh: '系统提示输入区' },
    ...
    settingsThinkingIntensity: { en: 'Intensity Level', zh: '思考强度' },
    settingsThinkingLevel_minimal: { en: 'Minimal', zh: '极简' },
    settingsThinkingLevel_low: { en: 'Low', zh: '低' },
    settingsThinkingLevel_medium: { en: 'Medium', zh: '中' },
    settingsThinkingLevel_high: { en: 'High', zh: '高' },
    ...
    settingsThinkingBudget_tokens: { en: 'tokens', zh: '个令牌' },
    settingsThinkingBudget_description: { en: 'Controls the maximum number of tokens the model can use for its internal thought process ({min}-{max}).', zh: '控制模型内部思考过程可使用的最大令牌数（{min}-{max}）。' },
    settingsThinking_gemma_tooltip: { en: 'Gemma 4 uses the <|think|> token to enable thinking mode. When enabled, the model will output reasoning in <|channel|thought> tags.', zh: 'Gemma 4 使用 <|think|> token 启用思考模式。启用后，模型会在 <|channel|thought> 标签中输出推理内容。' },
    settingsThinking_enabled_badge: { en: 'Thinking Enabled', zh: '思考已启用' },
    settingsThinking_inject_token: { en: 'Inject <|think|> token into system prompt', zh: '将 <|think|> token 注入系统提示' },
    settingsThinking_disabled: { en: 'Thinking mode disabled', zh: '思考模式已禁用' },
    settingsThinking_gemini_capabilities: { en: 'Gemini 3.0 Capabilities', zh: 'Gemini 3.0 能力' },
    settingsThinking_reasoning_enabled: { en: 'Reasoning Enabled', zh: '推理已启用' },
    settingsThinking_off_message: { en: 'Thinking process is disabled.', zh: '思考过程已禁用。' },
    ...
    settingsMediaResolution_live_tooltip: { en: 'Controls video/audio resolution for Live API.', zh: '控制 Live API 的视频/音频分辨率。' },
    settingsModelList_manage: { en: 'Manage Models', zh: '管理模型' },
    settingsModelList_cancel_edit: { en: 'Cancel Edit', zh: '取消编辑' },
    settingsModelList_edit: { en: 'Edit List', zh: '编辑列表' },
    settingsModelList_pinned: { en: 'Pinned', zh: '已固定' },
    settingsModelList_active: { en: 'Active', zh: '当前使用' },
    settingsModelList_set_active: { en: 'Set Active', zh: '设为当前模型' },
    settingsModelList_empty: { en: 'No models available.', zh: '暂无可用模型。' },
    settingsModelList_editor_empty: { en: 'No models in list. Add one or reset to defaults.', zh: '列表中暂无模型。可添加或恢复默认列表。' },
    settingsModelList_add: { en: 'Add Model', zh: '添加模型' },
    settingsModelList_reset: { en: 'Reset', zh: '重置' },
    settingsModelList_save: { en: 'Save List', zh: '保存列表' },
    settingsModelList_reset_confirm: { en: 'Reset model list to default? This will clear all custom additions.', zh: '将模型列表重置为默认值吗？这会清除所有自定义添加项。' },
    settingsModelList_id_placeholder: { en: 'Model ID (e.g. gemini-pro)', zh: '模型 ID（例如 gemini-pro）' },
    settingsModelList_name_placeholder: { en: 'Display Name', zh: '显示名称' },
    settingsModelList_remove: { en: 'Remove', zh: '移除' },

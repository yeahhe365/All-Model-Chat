export const dataSettings = {
  ...
  settingsInstallApp_unavailable_title: {
    en: 'App is already installed or not supported by your browser.',
    zh: '应用已安装或浏览器不支持安装。',
  },
  settingsInstallApp_manual_title: {

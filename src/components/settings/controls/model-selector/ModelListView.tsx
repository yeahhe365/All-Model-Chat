                        ...
                        >
                            ...
                            <div className="flex-grow min-w-0">
                                <div className="flex items-center gap-2">
                                    ...
                                    {model.isPinned && <span className="text-[10px] bg-[var(--theme-bg-tertiary)] px-1.5 py-0.5 rounded text-[var(--theme-text-tertiary)] border border-[var(--theme-border-secondary)]">{t('settingsPinnedModel')}</span>}
                                </div>

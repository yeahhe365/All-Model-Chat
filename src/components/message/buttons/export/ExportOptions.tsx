...
export const ExportOptions: React.FC<ExportOptionsProps> = ({ onExport, variant = 'message' }) => {
    ...
    const options = [
        { id: 'png' as const, icon: ImageIcon, label: t('export_option_png_label'), desc: currentDesc.png, colorClass: 'text-[var(--theme-text-link)]' },
        { id: 'html' as const, icon: FileCode2, label: t('export_option_html_label'), desc: currentDesc.html, colorClass: 'text-green-500' },
        { id: 'txt' as const, icon: FileText, label: t('export_option_txt_label'), desc: currentDesc.txt, colorClass: 'text-blue-500' },
        { id: 'json' as const, icon: FileJson, label: t('export_option_json_label'), desc: currentDesc.json, colorClass: 'text-orange-500' },
    ];

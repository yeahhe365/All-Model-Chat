...
const getLanguageBadgeConfig = (language: string): LanguageBadgeConfig => {
    ...
    if (['php', 'rb', 'ruby', 'rails', 'lua', 'pl', 'perl', 'java', 'jvm', 'c', 'cpp', 'c++', 'h', 'hpp', 'cs', 'csharp', 'c#', 'go', 'golang', 'rust', 'rs', 'swift', 'r', 'android', 'kotlin', 'kt', 'docker', 'dockerfile', 'git', 'diff', 'aws', 'jenkins', 'npm', 'yarn', 'pnpm', 'xml', 'svg', 'vue', 'vuejs', 'angular', 'ng'].includes(lang)) {
        return {
            badgeId: lang,
            iconId: 'braces',

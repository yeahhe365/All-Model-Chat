...
export const ApiUsageTab: React.FC<ApiUsageTabProps> = ({ apiKeyUsage, appSettings, currentChatSettings }) => {
    ...
    return (
        <div className="p-4 overflow-y-auto custom-scrollbar h-full">
            <h4 className="font-semibold text-lg text-[var(--theme-text-primary)] mb-4 flex items-center gap-2"><KeyRound size={20} /> {t('logViewer_api_usage_title')}</h4>
            ...
            {Array.from(displayApiKeyUsage.entries())
                ...
                return (
                    ...
                    <div className="flex justify-between items-start mb-2">
                        ...
                        {isActive && <span className="text-[10px] font-bold uppercase bg-green-900 text-green-300 px-2 py-0.5 rounded-full flex items-center gap-1"><CheckCircle size={10} /> {t('logViewer_active')}</span>}
                    </div>
                    <div className="mb-4">
